...
function handle_addCartItem(){
    ...
    //let imgSrc = ".img/Samosa.jpg";
    var imgSrc = document.querySelector(".food-items-image").src;
    console.log(title,price,imgSrc);
    
    // var shopProduct = this.parentElement;
    // var title = shopProduct.getElementByClassName("details-sub-title")[0].innerText;
    // var price = shopProduct.getElementByClassName("pricee")[0].innerText;
    // var imgSrc = shopProduct.getElementByClassName("food-items-image")[0].src;
    let newToAdd = {
        title,
        price,
        imgSrc,
